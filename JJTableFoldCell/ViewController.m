...
@property(nonatomic,strong) NSMutableArray<__kindof JJFlodCellModel *> *data;
...
-(void)loadData{
    ...
    for (int i = 0; i < netData.count; i++) {
        JJFlodCellModel *foldCellModel = [JJFlodCellModel modelWithDic:(NSDictionary *)netData[i]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    JJFlodCellModel *foldCellModel = self.data[indexPath.row];
    cell.textLabel.text = foldCellModel.text;
    
    return cell;
}

- (NSInteger)tableView:(UITableView *)tableView indentationLevelForRowAtIndexPath:(NSIndexPath *)indexPath {//不同cell的缩进
    JJFlodCellModel *foldCellModel = self.data[indexPath.row];
    return foldCellModel.level.intValue;
}

- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    JJFlodCellModel *didSelectFoldCellModel = self.data[indexPath.row];
